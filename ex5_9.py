...
def solve(input_data):
    ...
    provinces_startswith_h = [(i['name'], i['population']) for i in data if i['name'].startswith('H')]
    
    provinces_more_than_1m = [(i['name'], i['population']) for i in data if i['population'] > 1000000]
    ...
    provinces_startswith_h.sort(key = result1, reverse = True)
    provinces_more_than_1m.sort(key = result2, reverse = True)
